...
\titulo{VANSI: Uma ferramenta para visualização e ensino de algoritmos de análise sintática}
\data{2024}
\local{Quixadá}
...
\begin{document}
\ExpandArgs{c}\let{NC@find@X}\relax % Remove X is already defined warning
\imprimircapa
