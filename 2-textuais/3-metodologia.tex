...
Os endpoints da API foram definidos de acordo com o Quadro \ref{qua:endpoints}.
...
\resizebox{\textwidth}{!}{\begin{NiceTabular}{ccm[c]{10cm}}[corners,hvlines]
\CodeBefore
  \rowcolor{gray!15}{1-1}
\Body
\textbf{Endpoint} & \textbf{Método} & \textbf{Finalidade}  \\
$\backslash$ & GET & redirecionar para página\\
$\backslash$login & POST & registrar usuário\\
\end{NiceTabular}}
{\Fonte{fornecido pelo autor}}
\end{table}

Com a API pronta pode ser feita a conexão entre a ferramenta e a LMS. utilizando o serviço LTI de Dynamic Registration é possível fazer o cadastro da ferramenta na LMS utilizando um link para o endpoint de registro dinâmico da API.
