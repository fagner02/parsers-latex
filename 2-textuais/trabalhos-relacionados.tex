...
\section{PAVT}
No trabalho de \textcite{sangal2018pavt} foi criada a ferramenta PAVT (\textit{Parsing Algorithms Visualization Tool}) para visualização de seis algoritmos de análise sintática. A ferramenta apresenta uma caixa de entrada para informar a gramática a opção de importar uma gramática através de um arquivo. Há uma caixa de entrada para as \textit{string} a serem analisadas. Todos os elementos da ferramenta podem ser vistos na Figura \ref{fig:pavt}., no entanto, a visualização é realizada apenas pela leitura de um arquivo de texto gerado pela ferramenta, além de não mostrar instruções de como chegar ao resultado descrito no arquivo de texto. O \textit{software} também está apenas disponível em versão \textit{desktop} para o sistema operacional \textit{Windows}.

\begin{figure}[t!]
    \captionsetup{width=16cm}
    \Caption{\label{fig:pavt}Imagem da ferramenta PAVT}
    \tcbox[left=0cm, right=0cm, top=0cm, bottom=0cm,center]{\includegraphics[width=15.6cm, height=9.75cm]{figuras/pavt.png}}{
    \Fonte{\textcite{pavt}.}}
\end{figure}
% \begin{figure}[ht]
%     \captionsetup{width=16cm}
%     \Caption{\label{fig:pavt}Imagem da ferramenta PAVT}
%     \tcbox[left=0cm, right=0cm, top=0cm, bottom=0cm,center]{\includegraphics[width=15.6cm]{figuras/pavt1.png}}{
%     \Fonte{\textcite{pavt}.}}
% \end{figure}
...
\begin{figure}[t!]
    ...
    \tcbox[left=0cm, right=0cm, top=0cm, bottom=0cm,center]{\includegraphics[width=15.6cm, height=9.75cm]{figuras/jflap.png}}{
    \Fonte{\textcite{jflap}.}}
\end{figure}
